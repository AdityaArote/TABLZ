...
- Usage: Reference from command with `@D:/code/Project/tablez-demo2-allByAi/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/code/Project/tablez-demo2-allByAi/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/code/Project/tablez-demo2-allByAi/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
