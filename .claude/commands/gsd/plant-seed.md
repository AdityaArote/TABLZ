...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.claude/get-shit-done/workflows/plant-seed.md
</execution_context>

<process>
Execute the plant-seed workflow from @D:/code/Project/tablez-demo2-allByAi/.claude/get-shit-done/workflows/plant-seed.md end-to-end.
</process>
