...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.claude/get-shit-done/workflows/pr-branch.md
</execution_context>

<process>
Execute the pr-branch workflow from @D:/code/Project/tablez-demo2-allByAi/.claude/get-shit-done/workflows/pr-branch.md end-to-end.
</process>
