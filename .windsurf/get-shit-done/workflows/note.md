...
- **Global scope**: `D:/code/Project/tablez-demo2-allByAi/.windsurf/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/code/Project/tablez-demo2-allByAi/.windsurf/notes/`)
...
2. Glob `D:/code/Project/tablez-demo2-allByAi/.windsurf/notes/*.md` (if directory exists) — global notes
...
Global (D:/code/Project/tablez-demo2-allByAi/.windsurf/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/code/Project/tablez-demo2-allByAi/.windsurf/notes/` — works in any directory
