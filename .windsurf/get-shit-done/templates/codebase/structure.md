...
- Usage: Reference from command with `@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/code/Project/tablez-demo2-allByAi/.windsurf/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/code/Project/tablez-demo2-allByAi/.windsurf/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
