...
<!-- For checkpoint task examples and patterns, see @D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/references/checkpoints.md -->
...
See `D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/verify-phase.md` for verification logic.
