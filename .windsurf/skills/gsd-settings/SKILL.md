...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/settings.md
</execution_context>

<process>
**Follow the settings workflow** from `@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/settings.md`.
