...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/add-phase.md`.
