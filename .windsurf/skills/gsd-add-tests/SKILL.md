...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/add-tests.md end-to-end.
