...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@D:/code/Project/tablez-demo2-allByAi/.windsurf/get-shit-done/workflows/check-todos.md`.
