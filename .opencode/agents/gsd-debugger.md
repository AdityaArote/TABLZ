...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks D:/code/Project/tablez-demo2-allByAi/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done
                  → writes to D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
