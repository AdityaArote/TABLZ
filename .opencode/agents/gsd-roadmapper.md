...
Reference full template: `D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/templates/state.md`.
