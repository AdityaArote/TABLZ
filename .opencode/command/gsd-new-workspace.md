...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/workflows/new-workspace.md
@D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the new-workspace workflow from @D:/code/Project/tablez-demo2-allByAi/.opencode/get-shit-done/workflows/new-workspace.md end-to-end.
