...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/workflows/session-report.md end-to-end.
</process>
