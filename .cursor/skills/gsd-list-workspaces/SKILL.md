...
<execution_context>
@D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/workflows/list-workspaces.md
@D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/references/ui-brand.md
</execution_context>

<process>
Execute the list-workspaces workflow from @D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/workflows/list-workspaces.md end-to-end.
</process>
