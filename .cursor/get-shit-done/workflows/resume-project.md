...
<required_reading>
@D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "D:/code/Project/tablez-demo2-allByAi/.cursor/get-shit-done/bin/gsd-tools.cjs" init resume)
